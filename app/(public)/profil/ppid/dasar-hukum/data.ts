export const dasarHukum =[
    ...
    "Mengkoordinasikan dan mengonsolidasikan proses penyimpanan, pendokumentasian, penyediaan, dan pelayanan informasi publik",
    ...
    "Melakukan verifikasi dan dokumentasi informasi publik",
