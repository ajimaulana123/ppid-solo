...
import { DialogNews } from "@/components/admin/galeri/video/NewsFormDialog";
import { useState, useEffect } from "react";
import { NewsCard } from '@/components/admin/galeri/video/NewsCard';
import { LoadingView } from '@/components/admin/galeri/video/LoadingView';
import { ErrorView } from '@/components/admin/galeri/video/ErrorView';
...
export default function NewsPage() {
  ...
  const fetchNews = async () => {
    try {
      ...
      const url = `/api/activities-video-ppid?page=${currentPage}${
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main>
        <HeroSections title="Video OKE SIP!" />
            ...
            {newsData.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-500">
                  {currentSearch
                    ? `Tidak ditemukan video dengan kata kunci "${currentSearch}"`
