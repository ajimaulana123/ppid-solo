...
interface ProsedurLayananProps {
  content: {
    firstTitle: string;
...
export const ProsedurLayananEntity = ({ content }: ProsedurLayananProps) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {/* Vision Card - Lebar 2 kolom */}
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg p-8 relative overflow-hidden md:col-span-2">
