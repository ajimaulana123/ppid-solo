  ...
  return (
    <div className="space-y-4">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>Judul Lapora</FormLabel>
            <FormControl>
              <Input placeholder="Masukkan judul Podcast" {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel>Isi Podcast</FormLabel>
            <FormControl>
              <Textarea
                placeholder="Tulis isi Podcast disini..."
      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            <FormLabel>Gambar Podcast (Opsional)</FormLabel>
            <FormControl>
