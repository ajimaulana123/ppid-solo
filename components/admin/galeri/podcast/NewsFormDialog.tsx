  ...
  const onSubmit = async (data: NewsSchema) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorData.message || 'Gagal menambahkan Podcast');
      }
      ...
      toast({
        title: "Gagal",
        description: error instanceof Error ? error.message : 'Terjadi kesalahan saat menambahkan podcast',
        variant: "destructive"
      });
    } finally {
