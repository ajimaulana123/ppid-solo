...
const updateData = async (id: number, formData: FormData) => {
    const response = await fetch(`/api/comic-ppid/${id}`, {
        method: "PUT",
        body: formData,
    });
    ...
    const onSubmit = async (data: NewsSchema) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Komik telah berhasil diperbarui.",
                variant: "default",
            });
            ...
            toast({
                ...
                description: "Terjadi kesalahan saat memperbarui Komik. Silakan coba lagi.",
                variant: "destructive",
            });
        } finally {
