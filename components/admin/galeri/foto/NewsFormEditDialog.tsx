...
const updateData = async (id: number, formData: FormData) => {
    const response = await fetch(`/api/activities-image-ppid/${id}`, {
        method: "PUT",
        body: formData,
    });
    ...
    const onSubmit = async (data: NewsSchema) => {
        ...
        try {
            ...
            toast({
                ...
                description: "Foto telah berhasil diperbarui.",
                variant: "default",
            });
            ...
            toast({
                ...
                description: "Terjadi kesalahan saat memperbarui Foto. Silakan coba lagi.",
                variant: "destructive",
            });
        } finally {
